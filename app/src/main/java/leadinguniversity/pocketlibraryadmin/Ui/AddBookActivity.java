...
import leadinguniversity.pocketlibraryadmin.Util.DatePickerFragment;
...
public class AddBookActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0) {
                                    ...
                                    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                                        ...
                                        if (photoFile != null) {
                                            Uri photoURI = FileProvider.getUriForFile(AddBookActivity.this,
    ...
    @OnClick(R.id.add_new_bookB)
    public void addNewBook() {
        if (imageFile != null && pdfFileUri != null) {
            Utilities.showLoadingDialog(this, Color.DKGRAY);
            ...
            String pdffile = addPdfFileB.getText().toString();
            String publisherId = FirebaseAuth.getInstance().getUid();

            String bookId = FirebaseDatabase.getInstance().getReference(Constants.REF_BOOK).push().getKey();
            book = new Book(bookId, title, description, price, date, pdffile, publisherId);
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AddBookActivity.this, R.string.error_in_connection, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
